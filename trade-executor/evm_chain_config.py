...
_CHAIN_DEFAULTS: Dict[int, EvmChainConfig] = {
    8453: EvmChainConfig(
        ...
        entrypoint="0xe4645c9f3c479524B3B6F411B3Bcb9E0d2c28788",  # multi-note+split redeploy 2026-06-30 (verifiers match frontend zkey). Old: 0x2f7d…(single-note), 0xE0bbD38d…(mismatched verifier). Override via BASE_MAINNET_ENTRYPOINT.
